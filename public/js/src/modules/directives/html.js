    ...
    return {
        ...
        controller: [
            ...
            function ($scope, $element, configLoader) {
                ...
                $scope.registerScripts = function ($scripts) {
                ...
                $scope.registerStyles = function ($styles) {
                 ...
                 */
                $scope.formatDOM = function ($DOM, options) {
                    ...
                    $scripts.detach();
                    $DOM.find(configLoader.getMainSelector()).append($scripts);
                };
